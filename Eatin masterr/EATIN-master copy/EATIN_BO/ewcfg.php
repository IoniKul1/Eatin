...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "EATIN_BO"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => 'BsJTRho8djML4z7A', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/EATIN_BO.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{CC19BE4C-23D6-4992-89EF-6304995797F2}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MSSQL", "qs" => "[", "qe" => "]", "host" => "192.168.1.146", "port" => NULL, "user" => "sa", "pass" => "Kickassstrong140!", "db" => "EATIN"]
	],
	...
	"ADMIN_PASSWORD" => "marce1234", // Administrator password
	...
	"UPLOAD_ALLOWED_FILE_EXT" => "gif,jpg,jpeg,bmp,png,doc,docx,xls,xlsx,pdf,zip,css", // Allowed file extensions
