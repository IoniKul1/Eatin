...
ew.ready(ew.bundleIds, "<?php echo $RELATIVE_PATH ?>js/userevt.js", "load", function() {
	...
	function BO_Start(){$(document).ready(function(){console.log("BO_Start()"),AutoRefreshPedidos()})}function AutoRefreshPedidos(){-1!=window.location.href.indexOf("Pedidolist.php")&&setTimeout("window.location.reload();",5e4)}BO_Start();
});
</script>
</body>
</html>