 ...
 * Page class
 */
class ItemOptions_view extends ItemOptions
{
	...
	// Page object name
	public $PageObjName = "ItemOptions_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "ItemOptionslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "ItemOptionslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "ItemOptionslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
