...
class Categorias extends DbTable
{
	...
	public function __construct()
	{
		...
		// Update Table
		$this->UpdateTable = "[dbo].[Categorias]";
		$this->Dbid = 'DB';
		$this->ExportAll = TRUE;
		...
		// ID
		$this->ID = new DbField('Categorias', 'Categorias', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 20, 8, -1, FALSE, '[ID]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'NO');
		...
		// ID_Restaurant
		$this->ID_Restaurant = new DbField('Categorias', 'Categorias', 'x_ID_Restaurant', 'ID_Restaurant', '[ID_Restaurant]', 'CAST([ID_Restaurant] AS NVARCHAR)', 20, 8, -1, FALSE, '[ID_Restaurant]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'SELECT');
		...
		// DateCreation
		$this->DateCreation = new DbField('Categorias', 'Categorias', 'x_DateCreation', 'DateCreation', '[DateCreation]', CastDateFieldForLike("[DateCreation]", 0, "DB"), 135, 8, 0, FALSE, '[DateCreation]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// DateLastUpdate
		$this->DateLastUpdate = new DbField('Categorias', 'Categorias', 'x_DateLastUpdate', 'DateLastUpdate', '[DateLastUpdate]', CastDateFieldForLike("[DateLastUpdate]", 0, "DB"), 135, 8, 0, FALSE, '[DateLastUpdate]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// Active
		$this->Active = new DbField('Categorias', 'Categorias', 'x_Active', 'Active', '[Active]', 'CAST([Active] AS NVARCHAR)', 3, 4, -1, FALSE, '[Active]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'RADIO');
		$this->Active->Sortable = TRUE; // Allow sort
		switch ($CurrentLanguage) {
			case "en":
				$this->Active->Lookup = new Lookup('Active', 'Categorias', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
			default:
				$this->Active->Lookup = new Lookup('Active', 'Categorias', FALSE, '', ["","","",""], [], [], [], [], [], [], '', '');
				break;
		...
		// Nombre
		$this->Nombre = new DbField('Categorias', 'Categorias', 'x_Nombre', 'Nombre', '[Nombre]', '[Nombre]', 202, 50, -1, FALSE, '[Nombre]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// NombreEN
		$this->NombreEN = new DbField('Categorias', 'Categorias', 'x_NombreEN', 'NombreEN', '[NombreEN]', '[NombreEN]', 202, 50, -1, FALSE, '[NombreEN]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
	...
	public function getDetailUrl()
	{
		...
		// Detail url
		$detailUrl = "";
		if ($this->getCurrentDetailTable() == "Items") {
			$detailUrl = $GLOBALS["Items"]->getListUrl() . "?" . Config("TABLE_SHOW_MASTER") . "=" . $this->TableVar;
	...
	{
		return ($this->SqlFrom != "") ? $this->SqlFrom : "[dbo].[Categorias]";
	}
	...
	public function getViewUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("Categoriasview.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
	...
	public function getEditUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("Categoriasedit.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getCopyUrl($parm = "")
	{
		if ($parm != "")
			...
			$url = $this->keyUrl("Categoriasadd.php", $this->getUrlParm(Config("TABLE_SHOW_DETAIL") . "="));
		return $this->addMasterUrl($url);
	}
	...
	public function getUserIDSubquery(&$fld, &$masterfld)
	{
		global $UserTable;
		$wrk = "";
		$sql = "SELECT " . $masterfld->Expression . " FROM [dbo].[Categorias]";
