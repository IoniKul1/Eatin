 ...
 * Page class
 */
class Restaurant_delete extends Restaurant
{
	...
	// Page object name
	public $PageObjName = "Restaurant_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Restaurantlist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Restaurantlist.php"); // Return to list
			}
		}
	}
