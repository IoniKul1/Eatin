 ...
 * Page class
 */
class ItemxPedido_view extends ItemxPedido
{
	...
	// Page object name
	public $PageObjName = "ItemxPedido_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "ItemxPedidolist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "ItemxPedidolist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "ItemxPedidolist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
