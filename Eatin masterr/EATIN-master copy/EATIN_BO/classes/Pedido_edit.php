...
class Pedido_edit extends Pedido
{
	...
	public function run()
	{
		...
		$this->ID_Restaurant->Visible = FALSE;
	...
	protected function validateForm()
	{
		...
		if (in_array("ItemxPedido", $detailTblVar) && $GLOBALS["ItemxPedido"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("ItemxPedido", $detailTblVar) && $GLOBALS["ItemxPedido"]->DetailEdit) {
						...
						$editRow = $GLOBALS["ItemxPedido_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("ItemxPedido", $detailTblVar)) {
				...
				if ($GLOBALS["ItemxPedido_grid"]->DetailEdit) {
					$GLOBALS["ItemxPedido_grid"]->CurrentMode = "edit";
					$GLOBALS["ItemxPedido_grid"]->CurrentAction = "gridedit";
