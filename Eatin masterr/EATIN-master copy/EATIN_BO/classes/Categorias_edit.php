...
class Categorias_edit extends Categorias
{
	...
	protected function validateForm()
	{
		...
		if (in_array("Items", $detailTblVar) && $GLOBALS["Items"]->DetailEdit) {
			...
			if ($updateRow) {
				...
				if ($editRow) {
					if (in_array("Items", $detailTblVar) && $GLOBALS["Items"]->DetailEdit) {
						...
						$editRow = $GLOBALS["Items_grid"]->gridUpdate();
	...
	protected function setupDetailParms()
	{
		...
		if ($detailTblVar != "") {
			...
			if (in_array("Items", $detailTblVar)) {
				...
				if ($GLOBALS["Items_grid"]->DetailEdit) {
					$GLOBALS["Items_grid"]->CurrentMode = "edit";
					$GLOBALS["Items_grid"]->CurrentAction = "gridedit";
