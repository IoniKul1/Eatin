 ...
 * Page class
 */
class ItemOptions_delete extends ItemOptions
{
	...
	// Page object name
	public $PageObjName = "ItemOptions_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("ItemOptionslist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($rs = LoadRecordset($sql, $conn)) {
			...
			$rs->close();
			if (!$res) {
				$this->terminate("ItemOptionslist.php"); // Return to list
				return;
			}
		}
