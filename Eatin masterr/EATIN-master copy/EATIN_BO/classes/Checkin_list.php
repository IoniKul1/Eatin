 ...
 * Page class
 */
class Checkin_list extends Checkin
{
	...
	// Page object name
	public $PageObjName = "Checkin_list";

	// Grid form hidden field names
	public $FormName = "fCheckinlist";
	...
	public function __construct()
	{
		...
		$this->AddUrl = "Checkinadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "Checkindelete.php";
		$this->MultiUpdateUrl = "Checkinupdate.php";
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fCheckinlistsrch";
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fCheckinlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fCheckinlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fCheckinlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
