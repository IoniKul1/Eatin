 ...
 * Page class
 */
class _Table_edit extends _Table
{
	...
	// Page object name
	public $PageObjName = "_Table_edit";
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("_Tablelist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "_Tablelist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("_Tablelist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
