 ...
 * Page class
 */
class Categorias_grid extends Categorias
{
	...
	// Page object name
	public $PageObjName = "Categorias_grid";

	// Grid form hidden field names
	public $FormName = "fCategoriasgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_Nombre") && $CurrentForm->hasValue("o_Nombre") && $this->Nombre->CurrentValue != $this->Nombre->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_NombreEN") && $CurrentForm->hasValue("o_NombreEN") && $this->NombreEN->CurrentValue != $this->NombreEN->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_NombreEN"))
			$this->NombreEN->setOldValue($CurrentForm->getValue("o_NombreEN"));
	}
