 ...
 * Page class
 */
class State_view extends State
{
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "Statelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Statelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Statelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("Statelist.php"), "", $this->TableVar, TRUE);
		$pageId = "view";
