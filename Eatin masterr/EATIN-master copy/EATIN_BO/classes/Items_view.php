 ...
 * Page class
 */
class Items_view extends Items
{
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "Itemslist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Itemslist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Itemslist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
