 ...
 * Page class
 */
class _Table_view extends _Table
{
	...
	// Page object name
	public $PageObjName = "_Table_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "_Tablelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "_Tablelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "_Tablelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
