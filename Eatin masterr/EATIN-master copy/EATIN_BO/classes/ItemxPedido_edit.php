 ...
 * Page class
 */
class ItemxPedido_edit extends ItemxPedido
{
	...
	// Page object name
	public $PageObjName = "ItemxPedido_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// ID_Client
			$this->ID_Client->setDbValueDef($rsnew, $this->ID_Client->CurrentValue, NULL, $this->ID_Client->ReadOnly);
