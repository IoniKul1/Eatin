 ...
 * Page class
 */
class Client_grid extends Client
{
	...
	// Page object name
	public $PageObjName = "Client_grid";

	// Grid form hidden field names
	public $FormName = "fClientgrid";
...
//		$GLOBALS["Table"] = &$GLOBALS["MasterTable"];
	...
	public function emptyRow()
	{
		...
		if ($CurrentForm->hasValue("x_Phone") && $CurrentForm->hasValue("o_Phone") && $this->Phone->CurrentValue != $this->Phone->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_Banned") && $CurrentForm->hasValue("o_Banned") && $this->Banned->CurrentValue != $this->Banned->OldValue)
			return FALSE;
		if ($CurrentForm->hasValue("x_ClientToken") && $CurrentForm->hasValue("o_ClientToken") && $this->ClientToken->CurrentValue != $this->ClientToken->OldValue)
			return FALSE;
		return TRUE;
	}
	...
	protected function loadFormValues()
	{
		...
		if ($CurrentForm->hasValue("o_Banned"))
			$this->Banned->setOldValue($CurrentForm->getValue("o_Banned"));
		...
		if ($CurrentForm->hasValue("o_ClientToken"))
			$this->ClientToken->setOldValue($CurrentForm->getValue("o_ClientToken"));
	}
