 ...
 * Page class
 */
class ItemOptions_edit extends ItemOptions
{
	...
	// Page object name
	public $PageObjName = "ItemOptions_edit";
	...
	public function run()
	{
		...
		if (ValidApiRequest()) { // API request
			...
			if (!$Security->canEdit()) {
				...
				if ($Security->canList())
					$this->terminate(GetUrl("ItemOptionslist.php"));
				else
		...
		if (!$Security->canEdit()) {
			...
			$this->terminate("ItemOptionslist.php");
			return;
		}
		...
		switch ($this->CurrentAction) {
			case "show": // Get a record to display
				if (!$loaded) { // Load record based on key
					...
					$this->terminate("ItemOptionslist.php"); // No matching record, return to list
				}
				break;
			case "update": // Update
				$returnUrl = $this->getReturnUrl();
				if (GetPageName($returnUrl) == "ItemOptionslist.php")
	...
	protected function setupBreadcrumb()
	{
		...
		$Breadcrumb->add("list", $this->TableVar, $this->addMasterUrl("ItemOptionslist.php"), "", $this->TableVar, TRUE);
		$pageId = "edit";
