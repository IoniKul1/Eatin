...
// Project
define(PROJECT_NAMESPACE . "PROJECT_NAME", "BACKOFFICE_CADETERIAS"); // Project name
...
$CONFIG = [
	...
	"RANDOM_KEY" => '01b4NyMy6Jjkbz41', // Random key for encryption
	"ENCRYPTION_KEY" => '', // Encryption key for data protection
	"PROJECT_STYLESHEET_FILENAME" => "css/BACKOFFICE_CADETERIAS.css", // Project stylesheet file name
	...
	"PROJECT_ID" => "{68D35137-1670-419B-B841-52FFD5E14A4B}", // Project ID (GUID)
	...
	"CONNECTION_INFO" => [
		"DB" => ["id" => "DB", "type" => "MSSQL", "qs" => "[", "qe" => "]", "host" => "192.168.1.146", "port" => NULL, "user" => "sa", "pass" => "Kickassstrong140!", "db" => "Cadeterias"]
	],
	...
	"USER_TABLE_NAME" => "Cadeteria",
	"LOGIN_USERNAME_FIELD_NAME" => "Email",
	"LOGIN_PASSWORD_FIELD_NAME" => "Hashpass",
