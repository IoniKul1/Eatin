...
class index
{
	...
	public function run()
	{
		...
		if (!$Security->isLoggedIn())
			$Security->autoLogin();
		if ($Security->allowList(CurrentProjectID() . 'Cadete'))
			$this->terminate("Cadetelist.php"); // Exit and go to default page
		if ($Security->allowList(CurrentProjectID() . 'Cadeteria'))
			$this->terminate("Cadeterialist.php");
		if ($Security->allowList(CurrentProjectID() . 'Checkin'))
			$this->terminate("Checkinlist.php");
		if ($Security->allowList(CurrentProjectID() . 'Checkout'))
			$this->terminate("Checkoutlist.php");
		if ($Security->allowList(CurrentProjectID() . 'PedidoACadeteria'))
