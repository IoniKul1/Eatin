 ...
 * Page class
 */
class Checkin_view extends Checkin
{
	...
	// Page object name
	public $PageObjName = "Checkin_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "Checkinlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Checkinlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Checkinlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
