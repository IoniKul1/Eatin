 ...
 * Page class
 */
class Cadeteria_view extends Cadeteria
{
	...
	// Page object name
	public $PageObjName = "Cadeteria_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "Cadeterialist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Cadeterialist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Cadeterialist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
