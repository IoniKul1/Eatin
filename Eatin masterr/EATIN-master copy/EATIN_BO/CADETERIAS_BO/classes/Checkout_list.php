 ...
 * Page class
 */
class Checkout_list extends Checkout
{
	...
	// Page object name
	public $PageObjName = "Checkout_list";

	// Grid form hidden field names
	public $FormName = "fCheckoutlist";
	...
	public function __construct()
	{
		...
		// Table object (Checkout)
		if (!isset($GLOBALS["Checkout"]) || get_class($GLOBALS["Checkout"]) == PROJECT_NAMESPACE . "Checkout") {
			$GLOBALS["Checkout"] = &$this;
			$GLOBALS["Table"] = &$GLOBALS["Checkout"];
		}
		...
		$this->AddUrl = "Checkoutadd.php";
		$this->InlineAddUrl = $this->pageUrl() . "action=add";
		$this->GridAddUrl = $this->pageUrl() . "action=gridadd";
		$this->GridEditUrl = $this->pageUrl() . "action=gridedit";
		$this->MultiDeleteUrl = "Checkoutdelete.php";
		$this->MultiUpdateUrl = "Checkoutupdate.php";
		...
		if (!defined(PROJECT_NAMESPACE . "TABLE_NAME"))
			define(PROJECT_NAMESPACE . "TABLE_NAME", 'Checkout');
		...
		$this->FilterOptions->TagClassName = "ew-filter-option fCheckoutlistsrch";
	...
	protected function setupSortOrder()
	{
		...
		if (Get("order") !== NULL) {
			...
			$this->updateSort($this->ID_PedidoACadeteria); // ID_PedidoACadeteria
	...
	protected function resetCmd()
	{
		...
		if (StartsString("reset", $this->Command)) {
			...
			if ($this->Command == "resetsort") {
				...
				$this->ID_PedidoACadeteria->setSort("");
	...
	protected function setupOtherOptions()
	{
		...
		$item->Body = "<a class=\"ew-save-filter\" data-form=\"fCheckoutlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("SaveCurrentFilter") . "</a>";
		$item->Visible = FALSE;
		$item = &$this->FilterOptions->add("deletefilter");
		$item->Body = "<a class=\"ew-delete-filter\" data-form=\"fCheckoutlistsrch\" href=\"#\" onclick=\"return false;\">" . $Language->phrase("DeleteFilter") . "</a>";
		$item->Visible = FALSE;
		...
		$options = &$this->OtherOptions;
			...
			foreach ($this->ListActions->Items as $listaction) {
				if ($listaction->Select == ACTION_MULTIPLE) {
					...
					$item->Body = "<a class=\"ew-action ew-list-action\" title=\"" . HtmlEncode($caption) . "\" data-caption=\"" . HtmlEncode($caption) . "\" href=\"#\" onclick=\"return ew.submitAction(event,jQuery.extend({f:document.fCheckoutlist}," . $listaction->toJson(TRUE) . "));\">" . $icon . "</a>";
