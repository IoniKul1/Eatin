 ...
 * Page class
 */
class Cadete_view extends Cadete
{
	...
	// Page object name
	public $PageObjName = "Cadete_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "Cadetelist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Cadetelist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Cadetelist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
