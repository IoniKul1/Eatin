 ...
 * Page class
 */
class Cadeteria_edit extends Cadeteria
{
	...
	// Page object name
	public $PageObjName = "Cadeteria_edit";
	...
	protected function editRow()
	{
		...
		if ($rs->EOF) {
			...
			// Hashpass
			$this->Hashpass->setDbValueDef($rsnew, $this->Hashpass->CurrentValue, "", $this->Hashpass->ReadOnly || Config("ENCRYPTED_PASSWORD") && $rs->fields('Hashpass') == $this->Hashpass->CurrentValue);

			// fMult1
			$this->fMult1->setDbValueDef($rsnew, $this->fMult1->CurrentValue, 0, $this->fMult1->ReadOnly);

			// fMult2
			$this->fMult2->setDbValueDef($rsnew, $this->fMult2->CurrentValue, 0, $this->fMult2->ReadOnly);
