 ...
 * Page class
 */
class PedidoACadeteria_add extends PedidoACadeteria
{
	...
	// Page object name
	public $PageObjName = "PedidoACadeteria_add";
		...
		switch ($this->CurrentAction) {
			...
			case "insert": // Add new record
				...
				if ($this->addRow($this->OldRecordset)) { // Add successful
					...
					elseif (GetPageName($returnUrl) == "PedidoACadeteriaview.php")
	...
	protected function loadDefaultValues()
	{
		...
		$this->ID_Place1->CurrentValue = NULL;
		$this->ID_Place1->OldValue = $this->ID_Place1->CurrentValue;
		$this->ID_Place2->CurrentValue = NULL;
		$this->ID_Place2->OldValue = $this->ID_Place2->CurrentValue;
		...
		$this->InstruccionesPlace1->CurrentValue = NULL;
		$this->InstruccionesPlace1->OldValue = $this->InstruccionesPlace1->CurrentValue;
		$this->InstruccionesPlace2->CurrentValue = NULL;
		$this->InstruccionesPlace2->OldValue = $this->InstruccionesPlace2->CurrentValue;
		$this->Direccionalidad->CurrentValue = 1;
		$this->RemitoURL->CurrentValue = NULL;
		$this->RemitoURL->OldValue = $this->RemitoURL->CurrentValue;
		$this->Place1_Nombre->CurrentValue = NULL;
		$this->Place1_Nombre->OldValue = $this->Place1_Nombre->CurrentValue;
		$this->Place1_Country->CurrentValue = NULL;
		$this->Place1_Country->OldValue = $this->Place1_Country->CurrentValue;
		$this->Place1_UF->CurrentValue = NULL;
		$this->Place1_UF->OldValue = $this->Place1_UF->CurrentValue;
		$this->Plate1_Lat->CurrentValue = NULL;
		$this->Plate1_Lat->OldValue = $this->Plate1_Lat->CurrentValue;
		$this->Place1_Lon->CurrentValue = NULL;
		$this->Place1_Lon->OldValue = $this->Place1_Lon->CurrentValue;
		$this->Place1_Calle->CurrentValue = NULL;
		$this->Place1_Calle->OldValue = $this->Place1_Calle->CurrentValue;
		$this->Place1_Numero->CurrentValue = NULL;
		$this->Place1_Numero->OldValue = $this->Place1_Numero->CurrentValue;
		$this->Place1_Localidad->CurrentValue = NULL;
		$this->Place1_Localidad->OldValue = $this->Place1_Localidad->CurrentValue;
		$this->Place1_Piso->CurrentValue = NULL;
		$this->Place1_Piso->OldValue = $this->Place1_Piso->CurrentValue;
		$this->Place1_Depto->CurrentValue = NULL;
		$this->Place1_Depto->OldValue = $this->Place1_Depto->CurrentValue;
		$this->Place1_PersonaRecibe->CurrentValue = NULL;
		$this->Place1_PersonaRecibe->OldValue = $this->Place1_PersonaRecibe->CurrentValue;
		$this->Place1_PersonaRecibeTelefono->CurrentValue = NULL;
		$this->Place1_PersonaRecibeTelefono->OldValue = $this->Place1_PersonaRecibeTelefono->CurrentValue;
		$this->Place2_Nombre->CurrentValue = NULL;
		$this->Place2_Nombre->OldValue = $this->Place2_Nombre->CurrentValue;
		$this->Place2_Country->CurrentValue = NULL;
		$this->Place2_Country->OldValue = $this->Place2_Country->CurrentValue;
		$this->Place2_UF->CurrentValue = NULL;
		$this->Place2_UF->OldValue = $this->Place2_UF->CurrentValue;
		$this->Place2_Lat->CurrentValue = NULL;
		$this->Place2_Lat->OldValue = $this->Place2_Lat->CurrentValue;
		$this->Place2_Lon->CurrentValue = NULL;
		$this->Place2_Lon->OldValue = $this->Place2_Lon->CurrentValue;
		$this->Place2_Calle->CurrentValue = NULL;
		$this->Place2_Calle->OldValue = $this->Place2_Calle->CurrentValue;
		$this->Place2_Numero->CurrentValue = NULL;
		$this->Place2_Numero->OldValue = $this->Place2_Numero->CurrentValue;
		$this->Place2_Localidad->CurrentValue = NULL;
		$this->Place2_Localidad->OldValue = $this->Place2_Localidad->CurrentValue;
		$this->Place2_Piso->CurrentValue = NULL;
		$this->Place2_Piso->OldValue = $this->Place2_Piso->CurrentValue;
		$this->Place2_Depto->CurrentValue = NULL;
		$this->Place2_Depto->OldValue = $this->Place2_Depto->CurrentValue;
		$this->Place2_PersonaRecibe->CurrentValue = NULL;
		$this->Place2_PersonaRecibe->OldValue = $this->Place2_PersonaRecibe->CurrentValue;
		$this->Place2_PersonaRecibeTelefono->CurrentValue = NULL;
		$this->Place2_PersonaRecibeTelefono->OldValue = $this->Place2_PersonaRecibeTelefono->CurrentValue;
	...
	protected function newRow()
	{
		...
		$row['ID_Place1'] = $this->ID_Place1->CurrentValue;
		$row['ID_Place2'] = $this->ID_Place2->CurrentValue;
		$row['ID_Cadete'] = $this->ID_Cadete->CurrentValue;
		$row['ID_Status'] = $this->ID_Status->CurrentValue;
		$row['InstruccionesPlace1'] = $this->InstruccionesPlace1->CurrentValue;
		$row['InstruccionesPlace2'] = $this->InstruccionesPlace2->CurrentValue;
		$row['Direccionalidad'] = $this->Direccionalidad->CurrentValue;
		$row['RemitoURL'] = $this->RemitoURL->CurrentValue;
		$row['Place1_Nombre'] = $this->Place1_Nombre->CurrentValue;
		$row['Place1_Country'] = $this->Place1_Country->CurrentValue;
		$row['Place1_UF'] = $this->Place1_UF->CurrentValue;
		$row['Plate1_Lat'] = $this->Plate1_Lat->CurrentValue;
		$row['Place1_Lon'] = $this->Place1_Lon->CurrentValue;
		$row['Place1_Calle'] = $this->Place1_Calle->CurrentValue;
		$row['Place1_Numero'] = $this->Place1_Numero->CurrentValue;
		$row['Place1_Localidad'] = $this->Place1_Localidad->CurrentValue;
		$row['Place1_Piso'] = $this->Place1_Piso->CurrentValue;
		$row['Place1_Depto'] = $this->Place1_Depto->CurrentValue;
		$row['Place1_PersonaRecibe'] = $this->Place1_PersonaRecibe->CurrentValue;
		$row['Place1_PersonaRecibeTelefono'] = $this->Place1_PersonaRecibeTelefono->CurrentValue;
		$row['Place2_Nombre'] = $this->Place2_Nombre->CurrentValue;
		$row['Place2_Country'] = $this->Place2_Country->CurrentValue;
		$row['Place2_UF'] = $this->Place2_UF->CurrentValue;
		$row['Place2_Lat'] = $this->Place2_Lat->CurrentValue;
		$row['Place2_Lon'] = $this->Place2_Lon->CurrentValue;
		$row['Place2_Calle'] = $this->Place2_Calle->CurrentValue;
		$row['Place2_Numero'] = $this->Place2_Numero->CurrentValue;
		$row['Place2_Localidad'] = $this->Place2_Localidad->CurrentValue;
		$row['Place2_Piso'] = $this->Place2_Piso->CurrentValue;
		$row['Place2_Depto'] = $this->Place2_Depto->CurrentValue;
		$row['Place2_PersonaRecibe'] = $this->Place2_PersonaRecibe->CurrentValue;
		$row['Place2_PersonaRecibeTelefono'] = $this->Place2_PersonaRecibeTelefono->CurrentValue;
	...
	protected function addRow($rsold = NULL)
	{
		...
		// ID_Place1
		$this->ID_Place1->setDbValueDef($rsnew, $this->ID_Place1->CurrentValue, NULL, FALSE);

		// ID_Place2
		$this->ID_Place2->setDbValueDef($rsnew, $this->ID_Place2->CurrentValue, NULL, FALSE);

		// ID_Cadete
		$this->ID_Cadete->setDbValueDef($rsnew, $this->ID_Cadete->CurrentValue, NULL, FALSE);

		// ID_Status
		$this->ID_Status->setDbValueDef($rsnew, $this->ID_Status->CurrentValue, NULL, FALSE);

		// InstruccionesPlace1
		$this->InstruccionesPlace1->setDbValueDef($rsnew, $this->InstruccionesPlace1->CurrentValue, NULL, FALSE);

		// InstruccionesPlace2
		$this->InstruccionesPlace2->setDbValueDef($rsnew, $this->InstruccionesPlace2->CurrentValue, NULL, FALSE);

		// Direccionalidad
		$this->Direccionalidad->setDbValueDef($rsnew, $this->Direccionalidad->CurrentValue, NULL, strval($this->Direccionalidad->CurrentValue) == "");

		// RemitoURL
		$this->RemitoURL->setDbValueDef($rsnew, $this->RemitoURL->CurrentValue, NULL, FALSE);

		// Place1_Nombre
		$this->Place1_Nombre->setDbValueDef($rsnew, $this->Place1_Nombre->CurrentValue, NULL, FALSE);

		// Place1_Country
		$this->Place1_Country->setDbValueDef($rsnew, $this->Place1_Country->CurrentValue, NULL, FALSE);

		// Place1_UF
		$this->Place1_UF->setDbValueDef($rsnew, $this->Place1_UF->CurrentValue, NULL, FALSE);

		// Plate1_Lat
		$this->Plate1_Lat->setDbValueDef($rsnew, $this->Plate1_Lat->CurrentValue, NULL, FALSE);

		// Place1_Lon
		$this->Place1_Lon->setDbValueDef($rsnew, $this->Place1_Lon->CurrentValue, NULL, FALSE);

		// Place1_Calle
		$this->Place1_Calle->setDbValueDef($rsnew, $this->Place1_Calle->CurrentValue, NULL, FALSE);

		// Place1_Numero
		$this->Place1_Numero->setDbValueDef($rsnew, $this->Place1_Numero->CurrentValue, NULL, FALSE);

		// Place1_Localidad
		$this->Place1_Localidad->setDbValueDef($rsnew, $this->Place1_Localidad->CurrentValue, NULL, FALSE);

		// Place1_Piso
		$this->Place1_Piso->setDbValueDef($rsnew, $this->Place1_Piso->CurrentValue, NULL, FALSE);

		// Place1_Depto
		$this->Place1_Depto->setDbValueDef($rsnew, $this->Place1_Depto->CurrentValue, NULL, FALSE);

		// Place1_PersonaRecibe
		$this->Place1_PersonaRecibe->setDbValueDef($rsnew, $this->Place1_PersonaRecibe->CurrentValue, NULL, FALSE);

		// Place1_PersonaRecibeTelefono
		$this->Place1_PersonaRecibeTelefono->setDbValueDef($rsnew, $this->Place1_PersonaRecibeTelefono->CurrentValue, NULL, FALSE);

		// Place2_Nombre
		$this->Place2_Nombre->setDbValueDef($rsnew, $this->Place2_Nombre->CurrentValue, NULL, FALSE);

		// Place2_Country
		$this->Place2_Country->setDbValueDef($rsnew, $this->Place2_Country->CurrentValue, NULL, FALSE);

		// Place2_UF
		$this->Place2_UF->setDbValueDef($rsnew, $this->Place2_UF->CurrentValue, NULL, FALSE);

		// Place2_Lat
		$this->Place2_Lat->setDbValueDef($rsnew, $this->Place2_Lat->CurrentValue, NULL, FALSE);

		// Place2_Lon
		$this->Place2_Lon->setDbValueDef($rsnew, $this->Place2_Lon->CurrentValue, NULL, FALSE);

		// Place2_Calle
		$this->Place2_Calle->setDbValueDef($rsnew, $this->Place2_Calle->CurrentValue, NULL, FALSE);

		// Place2_Numero
		$this->Place2_Numero->setDbValueDef($rsnew, $this->Place2_Numero->CurrentValue, NULL, FALSE);

		// Place2_Localidad
		$this->Place2_Localidad->setDbValueDef($rsnew, $this->Place2_Localidad->CurrentValue, NULL, FALSE);

		// Place2_Piso
		$this->Place2_Piso->setDbValueDef($rsnew, $this->Place2_Piso->CurrentValue, NULL, FALSE);

		// Place2_Depto
		$this->Place2_Depto->setDbValueDef($rsnew, $this->Place2_Depto->CurrentValue, NULL, FALSE);

		// Place2_PersonaRecibe
		$this->Place2_PersonaRecibe->setDbValueDef($rsnew, $this->Place2_PersonaRecibe->CurrentValue, NULL, FALSE);

		// Place2_PersonaRecibeTelefono
		$this->Place2_PersonaRecibeTelefono->setDbValueDef($rsnew, $this->Place2_PersonaRecibeTelefono->CurrentValue, NULL, FALSE);

		// ID_Cadeteria
		$this->ID_Cadeteria->setDbValueDef($rsnew, $this->ID_Cadeteria->CurrentValue, NULL, FALSE);
