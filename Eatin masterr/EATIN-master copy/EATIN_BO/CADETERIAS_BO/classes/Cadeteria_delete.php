 ...
 * Page class
 */
class Cadeteria_delete extends Cadeteria
{
	...
	// Page object name
	public $PageObjName = "Cadeteria_delete";
	...
	public function run()
	{
		...
		if ($filter == "") {
			$this->terminate("Cadeterialist.php"); // Prevent SQL injection, return to list
			return;
		}
		...
		if ($this->isShow()) { // Load records for display
			...
			if ($this->TotalRecords <= 0) { // No record found, exit
				...
				$this->terminate("Cadeterialist.php"); // Return to list
			}
		}
	}
