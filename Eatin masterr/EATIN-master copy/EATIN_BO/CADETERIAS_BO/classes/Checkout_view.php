 ...
 * Page class
 */
class Checkout_view extends Checkout
{
	...
	// Page object name
	public $PageObjName = "Checkout_view";
	...
	public function run()
	{
		...
		if ($this->isPageRequest()) { // Validate request
			if (Get("ID") !== NULL) {
				...
				$returnUrl = "Checkoutlist.php"; // Return to list
			}
			...
			switch ($this->CurrentAction) {
				case "show": // Get a record to display
					...
					if (!$res) { // Load record based on key
						...
						$returnUrl = "Checkoutlist.php"; // No matching record, return to list
					}
			}
		} else {
			$returnUrl = "Checkoutlist.php"; // Not page request, return to list
		}
		if ($returnUrl != "") {
