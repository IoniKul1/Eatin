...
class Checkin extends DbTable
{
	...
	public function __construct()
	{
		...
		// ID
		$this->ID = new DbField('Checkin', 'Checkin', 'x_ID', 'ID', '[ID]', 'CAST([ID] AS NVARCHAR)', 20, 8, -1, FALSE, '[ID]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_Cadete
		$this->ID_Cadete = new DbField('Checkin', 'Checkin', 'x_ID_Cadete', 'ID_Cadete', '[ID_Cadete]', 'CAST([ID_Cadete] AS NVARCHAR)', 20, 8, -1, FALSE, '[ID_Cadete]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_PedidoACadeteria
		$this->ID_PedidoACadeteria = new DbField('Checkin', 'Checkin', 'x_ID_PedidoACadeteria', 'ID_PedidoACadeteria', '[ID_PedidoACadeteria]', 'CAST([ID_PedidoACadeteria] AS NVARCHAR)', 20, 8, -1, FALSE, '[ID_PedidoACadeteria]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// FechaCreacion
		$this->FechaCreacion = new DbField('Checkin', 'Checkin', 'x_FechaCreacion', 'FechaCreacion', '[FechaCreacion]', CastDateFieldForLike("[FechaCreacion]", 0, "DB"), 135, 8, 0, FALSE, '[FechaCreacion]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
		...
		// ID_Cadeteria
		$this->ID_Cadeteria = new DbField('Checkin', 'Checkin', 'x_ID_Cadeteria', 'ID_Cadeteria', '[ID_Cadeteria]', 'CAST([ID_Cadeteria] AS NVARCHAR)', 20, 8, -1, FALSE, '[ID_Cadeteria]', FALSE, FALSE, FALSE, 'FORMATTED TEXT', 'TEXT');
